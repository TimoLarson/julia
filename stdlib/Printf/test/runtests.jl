...
@testset "basics" begin
    ...
    @test string(Printf.Format("%a").formats[1]; bigfloat=true) == "%Ra"
...
@testset "integers" begin
    ...
    @test Printf.@sprintf("%#.25llo", -100) == "-0o0000000000000000000000144"
    @test Printf.@sprintf("%#+24.20llo", -100) == " -0o00000000000000000144"
    @test Printf.@sprintf("%#+18.21llX", -100) == "-0X000000000000000000064"
    @test Printf.@sprintf("%#+20.24llo", -100) == "-0o000000000000000000000144"
    ...
    @test Printf.@sprintf("%#-8.5llo", 100) == "0o00144 "
    ...
    @test Printf.@sprintf("%#08o",  1) == "0o000001"
    ...
    @test Printf.@sprintf("%+ X",  305441741) == "+1234ABCD"
    @test Printf.@sprintf("%+ X",  UInt(3989525555)) == "+EDCB5433"
    @test Printf.@sprintf("%#o",  511) == "0o777"
    @test Printf.@sprintf("%#o",  UInt(4294966785)) == "0o37777777001"
    @test Printf.@sprintf("%#x",  305441741) == "0x1234abcd"
    @test Printf.@sprintf("%#x",  UInt(3989525555)) == "0xedcb5433"
    @test Printf.@sprintf("%#X",  305441741) == "0X1234ABCD"
    @test Printf.@sprintf("%#X",  UInt(3989525555)) == "0XEDCB5433"
    @test Printf.@sprintf("%#o",  UInt(0)) == "0o0"
    ...
    @test Printf.@sprintf("%020X",  305441741) == "0000000000001234ABCD"
    @test Printf.@sprintf("%020X",  UInt(3989525555)) == "000000000000EDCB5433"
    @test Printf.@sprintf("%#20o",  511) == "               0o777"
    @test Printf.@sprintf("%#20o",  UInt(4294966785)) == "       0o37777777001"
    @test Printf.@sprintf("%#20x",  305441741) == "          0x1234abcd"
    @test Printf.@sprintf("%#20x",  UInt(3989525555)) == "          0xedcb5433"
    @test Printf.@sprintf("%#20X",  305441741) == "          0X1234ABCD"
    @test Printf.@sprintf("%#20X",  UInt(3989525555)) == "          0XEDCB5433"
    @test Printf.@sprintf("%#020o",  511) == "0o000000000000000777"
    @test Printf.@sprintf("%#020o",  UInt(4294966785)) == "0o000000037777777001"
